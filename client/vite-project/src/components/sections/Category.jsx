  ...
  return (
    <div className="xs:hidden md:block ">
      <div className="flex flex-wrap md:ml-[10%]">
        <a
          href="/games"
          className="flex items-center justify-center w-auto h-10 p-4 m-2 rounded-full bg-gray-700 cursor-pointer"
        ...
        <a
          ...
          style={{ borderRadius: "0.7rem" }}
        >
          <p className="text-white">Beauty</p>
        </a>
        <a
          ...
          style={{ borderRadius: "0.7rem" }}
        >
          <p className="text-white">Action&Adventure</p>
        </a>
        <a
          href="/sports"
          className="flex items-center justify-center w-auto h-10 p-4 m-2 rounded-full bg-gray-700 cursor-pointer"
